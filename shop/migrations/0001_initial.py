    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ImageField(blank=True, default='headers/default.jpg', null=True, upload_to='headers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='wishlistitem', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Subcategory',
